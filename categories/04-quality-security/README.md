...
- `gdpr-ccpa-compliance` - GDPR and CCPA/CPRA review of data flows, consent, and rights handling.
...
- `ui-ux-tester` - Exhaustive UI/UX flow testing with structured defect reporting.
